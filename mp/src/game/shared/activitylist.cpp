...
//HL2MP
	...
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_JUMP_PHYSGUN );
  	...
  	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_IDLE_GAUSS );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_RUN_GAUSS );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_IDLE_CROUCH_GAUSS );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_WALK_CROUCH_GAUSS );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_GESTURE_RANGE_ATTACK_GAUSS );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_GESTURE_RELOAD_GAUSS );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_JUMP_GAUSS );

  	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_IDLE_FLAMETHROWER );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_RUN_FLAMETHROWER );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_IDLE_CROUCH_FLAMETHROWER );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_WALK_CROUCH_FLAMETHROWER );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_GESTURE_RANGE_ATTACK_FLAMETHROWER );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_GESTURE_RELOAD_FLAMETHROWER );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_JUMP_FLAMETHROWER );
	...
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_DRIVE_AIRBOAT_LEFT);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_DRIVE_AIRBOAT);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_DRIVE_AIRBOAT_RIGHT);

	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_DRIVE_JEEP_LEFT);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_DRIVE_JEEP);
	REGISTER_SHARED_ACTIVITY(ACT_HL2MP_DRIVE_JEEP_RIGHT);
