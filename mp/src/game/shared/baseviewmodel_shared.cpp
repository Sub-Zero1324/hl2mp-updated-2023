...
void CBaseViewModel::CalcViewModelView( CBasePlayer *owner, const Vector& eyePosition, const QAngle& eyeAngles )
{
	...
	//		CalcViewModelLag( vmorigin, vmangles, vmangoriginal ); // Sub-Zero removed for Viewmodel Prediction Fix
#endif
		}
	}
	...
	{
		// Add lag
		CalcViewModelLag( vmorigin, vmangles, vmangoriginal ); // Sub-Zero Added for Viewmodel Prediction Fix
