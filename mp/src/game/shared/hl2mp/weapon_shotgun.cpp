...
private:
	...
	CNetworkVar( bool,	m_bInReload ); // Sub-Zero Added to fix Shotgun reload animation getting stuck when switching weapons	
...
public:
	...
	void Pump( void );
	bool Holster( CBaseCombatWeapon *pSwitchingTo = NULL ); // Sub-Zero Added to fix Shotgun reload animation getting stuck when switching weapons
...
BEGIN_NETWORK_TABLE( CWeaponShotgun, DT_WeaponShotgun )
	...
	RecvPropBool( RECVINFO( m_bInReload ) ), // Sub-Zero Added to fix Shotgun reload animation getting stuck when switching weapons
#else
	...
	SendPropBool( SENDINFO( m_bInReload ) ), // Sub-Zero Added to fix Shotgun reload animation getting stuck when switching weapons
#endif
END_NETWORK_TABLE()
...
BEGIN_PREDICTION_DATA( CWeaponShotgun )
	...
	DEFINE_PRED_FIELD( m_bInReload, FIELD_BOOLEAN, FTYPEDESC_INSENDTABLE ), // Sub-Zero Added to fix Shotgun reload animation getting stuck when switching weapons
END_PREDICTION_DATA()
#endif
...
void CWeaponShotgun::Precache(void)
{
	...
	PrecacheParticleSystem("hl2mmod_muzzleflash_shotgun_alt");
	BaseClass::Precache();
}
//-----------------------------------------------------------------------------
...
#ifdef CLIENT_DLL
	DispatchParticleEffect("hl2mmod_muzzleflash_shotgun", PATTACH_POINT_FOLLOW, pPlayer->GetViewModel(), "muzzle", true);
#endif
#ifndef CLIENT_DLL
	DispatchParticleEffect("hl2mmod_muzzleflash_npc_shotgun", PATTACH_POINT_FOLLOW, this, "muzzle", true);
#endif
...
#ifdef CLIENT_DLL
	DispatchParticleEffect("hl2mmod_muzzleflash_shotgun_alt", PATTACH_POINT_FOLLOW, pPlayer->GetViewModel(), "muzzle", true);
#endif
#ifndef CLIENT_DLL
	DispatchParticleEffect("hl2mmod_muzzleflash_npc_shotgun", PATTACH_POINT_FOLLOW, this, "muzzle", true);
#endif
...
// Purpose: 
//==================================================
// Sub-Zero Added to fix Shotgun reload animation getting stuck when switching weapons
