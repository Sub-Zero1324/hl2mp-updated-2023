...
void CWeaponSMG1::Precache( void )
{
	...
	PrecacheParticleSystem("hl2mmod_muzzleflash_npc_smg1");
	PrecacheParticleSystem("hl2mmod_muzzleflash_smg1_alt");
	PrecacheParticleSystem("hl2mmod_muzzleflash_npc_smg1_alt");
...
// MuzzleLight
//---------------------------------------------------------
void CWeaponSMG1::MuzzleLight(void)
{
#ifdef CLIENT_DLL
...
Activity CWeaponSMG1::GetPrimaryAttackActivity( void )
{
	...
	DispatchParticleEffect("hl2mmod_muzzleflash_smg1", PATTACH_POINT_FOLLOW, pOwner->GetViewModel(), "muzzle", true);
#endif
#ifndef CLIENT_DLL
	DispatchParticleEffect("hl2mmod_muzzleflash_npc_smg1", PATTACH_POINT_FOLLOW, this, "muzzle", true);
#endif
...
void CWeaponSMG1::SecondaryAttack( void )
{
...
#ifdef CLIENT_DLL
	CBasePlayer* pOwner = ToBasePlayer(GetOwner());
	DispatchParticleEffect("hl2mmod_muzzleflash_smg1_alt", PATTACH_POINT_FOLLOW, pOwner->GetViewModel(), "muzzle", true);
#endif
#ifndef CLIENT_DLL
	DispatchParticleEffect("hl2mmod_muzzleflash_npc_smg1_alt", PATTACH_POINT_FOLLOW, this, "muzzle", true);
#endif
	...
	Vector	muzzlePoint = pPlayer->Weapon_ShootPosition() + vForward * -8.0f + vRight * 6.0f + vUp * -3.0f;
	...
	//Create the grenade
	CGrenadeAR2 *pGrenade = (CGrenadeAR2*)Create( "grenade_ar2", muzzlePoint, vecAngles, pPlayer );
