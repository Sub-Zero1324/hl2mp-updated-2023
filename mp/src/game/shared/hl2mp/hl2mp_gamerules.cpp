...
#ifdef DEBUG	//Sub-Zero Removed to Allow Server Side bots
	#include "hl2mp_bot_temp.h"
#endif  //Sub-Zero Removed to Allow Server Side bots
...
CAmmoDef *GetAmmoDef()
{
	...
	if ( !bInitted )
	{
        ...
        def.AddAmmoType("BLAST",			DMG_BLAST,					TRACER_LINE_AND_WHIZ,	0,			0,			3,			BULLET_IMPULSE(200, 1225),	0 );
        def.AddAmmoType("AK47",				DMG_BULLET,					TRACER_LINE_AND_WHIZ,	0,			0,			250,		BULLET_IMPULSE(200, 1225),	0 );
		def.AddAmmoType("LASER",		    DMG_BLAST,				    TRACER_LINE_AND_WHIZ,	0,			0,			150,		BULLET_IMPULSE(200, 1225),	0 );
        def.AddAmmoType("SniperRound",		DMG_BULLET,					TRACER_LINE_AND_WHIZ,	0,			0,			50,			BULLET_IMPULSE(200, 1225),	0 );
		//def.AddAmmoType("GaussEnergy",		DMG_SHOCK,					TRACER_LINE_AND_WHIZ,	0,			0,			150,		BULLET_IMPULSE(200, 1225),	0 );
		def.AddAmmoType("MoonRaker",		DMG_BULLET,					TRACER_NONE,	        0,			0,			1,		    BULLET_IMPULSE(200, 1225),	0 );

		def.AddAmmoType("Hopwire",			DMG_BLAST,					TRACER_NONE,			0,			0,			120,		0,							0 );

		def.AddAmmoType("Gravity",			DMG_CLUB,				    TRACER_NONE,			0,			0,			225,		0,							0 );
		...
		def.AddAmmoType("Laser",            DMG_BULLET,                 TRACER_NONE,           0,          0,          80,          BULLET_IMPULSE(200, 1225), 0 );
		def.AddAmmoType("AirboatGun",		DMG_AIRBOAT,				TRACER_LINE,			"sk_plr_dmg_airboat",		"sk_npc_dmg_airboat",		NULL,					BULLET_IMPULSE(10, 600), 0 ); // Sub-Zero Added to fix AirBoad damge and ammo counter.
		def.AddAmmoType("GaussEnergy",		DMG_SHOCK,					TRACER_LINE_AND_WHIZ,	0,			0,			150,		BULLET_IMPULSE(200, 1225),	0 ); // Sub-Zero Added for Tau Cannon Ammo.
	}
