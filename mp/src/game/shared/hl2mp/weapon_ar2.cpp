...
void CWeaponAR2::Precache( void )
{
	...
	PrecacheParticleSystem("hl2mmod_muzzleflash_ar2_alt");
	PrecacheParticleSystem("hl2mmod_muzzleflash_npc_ar2_alt");
...
#ifdef CLIENT_DLL
	DispatchParticleEffect("hl2mmod_muzzleflash_ar2_alt", PATTACH_POINT_FOLLOW, pOwner->GetViewModel(), "muzzle", true);
#endif
#ifndef CLIENT_DLL
	DispatchParticleEffect("hl2mmod_muzzleflash_npc_ar2_alt", PATTACH_POINT_FOLLOW, this, "muzzle", true);
#endif
...
#ifdef CLIENT_DLL
	DispatchParticleEffect("hl2mmod_muzzleflash_ar2", PATTACH_POINT_FOLLOW, pPlayer->GetViewModel(), "muzzle", true);
#endif
#ifndef CLIENT_DLL
