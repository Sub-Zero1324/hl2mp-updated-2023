...
void CWeaponPistol::PrimaryAttack( void )
{
	...
	DispatchParticleEffect("hl2mmod_muzzleflash_pistol", PATTACH_POINT_FOLLOW, pPlayer->GetViewModel(), "muzzle", true);
#endif
#ifndef CLIENT_DLL
	DispatchParticleEffect("hl2mmod_muzzleflash_npc_pistol", PATTACH_POINT_FOLLOW, this, "muzzle", true);
#endif
