...
// MuzzleLight
//---------------------------------------------------------
void CWeaponPhysCannon::MuzzleLight(void)
{
#ifdef CLIENT_DLL
...
{
CDisablePredictionFiltering disabler; // Sub-Zero Added to fix Physcannot Sound effect.
#ifndef CLIENT_DLL
...
void CWeaponPhysCannon::DetachObject( bool playSound, bool wasLaunched )
{
	...
	if ( GetMotorSound() )
	{
		...
		StopSound("Weapon_PhysCannon.HoldSound");
		StopWeaponSound(SPECIAL4);
	}
...
{
#ifdef CLIENT_DLL // Sub-Zero Added for Physcannon Phys_swap issue.
...
#endif #ifdef CLIENT_DLL // Sub-Zero Added for Physcannon Phys_swap issue.
}
