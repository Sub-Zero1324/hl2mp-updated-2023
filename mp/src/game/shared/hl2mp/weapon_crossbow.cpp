...
//ConVar cl_crossbow_auto_zoom("cl_crossbow_auto_zoom", "1", FCVAR_CLIENTCMD_CAN_EXECUTE, "Stop zooming When bolt is fired"); // Sub-Zero Stop zooming When bolt is fired
...
//	{ ACT_HL2MP_GESTURE_RELOAD,			ACT_HL2MP_GESTURE_RELOAD_CROSSBOW,			false }, // Sub-Zero Removed to fix Reload animation.
	{ ACT_HL2MP_GESTURE_RELOAD,			ACT_HL2MP_GESTURE_RELOAD_AR2,			    false }, // Sub-Zero Added to fix Reload animation.
...
void CWeaponCrossbow::FireBolt( void )
{
	...
	//if (cl_crossbow_auto_zoom.GetBool())
	//{
	//	if (m_bInZoom)
	//	{
	//		ToggleZoom();
...
{
CDisablePredictionFiltering disabler; // Sub-Zero Added to fix Crossbow reload sound.
