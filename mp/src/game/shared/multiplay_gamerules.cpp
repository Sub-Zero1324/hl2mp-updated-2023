...
ConVar mp_ear_ringing( "mp_ear_ringing", "1", FCVAR_ARCHIVE, "Ear ringing on/off"); // Sub-Zero Enable/Disable Ear Ringing Sounds
...
//=============================================================================
	...
	float CMultiplayRules::FlPlayerFallDamage( CBasePlayer *pPlayer )
	{
		...
		default:
		case 0:// fixed
			return 0.001; // Changed from 10 to 0.001 so if mp_falldamage is 0 then there will be 0 damage Sub-Zero
			break;
		}
	} 
