...
void CHL2MPClientScoreBoardDialog::AddHeader()
{
	...
	m_pPlayerList->AddColumnToSection(0, "death", "", 0, scheme()->GetProportionalScaledValueEx( GetScheme(), CSTRIKE_CLASS_WIDTH ) );
...
void CHL2MPClientScoreBoardDialog::AddSection(int teamType, int teamNumber)
{
	...
	if ( teamType == TYPE_TEAM )
	{
		...
		m_pPlayerList->AddColumnToSection(sectionID, "death", "" , 0, scheme()->GetProportionalScaledValueEx( GetScheme(), CSTRIKE_CLASS_WIDTH ) );
	...
	else if ( teamType == TYPE_SPECTATORS )
	{
		...
		m_pPlayerList->AddColumnToSection(sectionID, "death", "" , 0, scheme()->GetProportionalScaledValueEx( GetScheme(), 100 ) );
	}
}
