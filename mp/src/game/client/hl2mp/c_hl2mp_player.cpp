...
static ConVar cl_fp_ragdoll ( "cl_fp_ragdoll", "0", FCVAR_ARCHIVE, "Allow first person ragdolls" ); // Sub-Zero Added the option to use First Person Ragdolls
static ConVar cl_fp_ragdoll_auto ( "cl_fp_ragdoll_auto", "1", FCVAR_ARCHIVE, "Autoswitch to ragdoll thirdperson-view when necessary" ); // Sub-Zero Added the option to use First Person Ragdolls
...
/* // Sub-Zero First Person Ragdolls
...
// Sub-Zero Added the option to use First Person Ragdolls
