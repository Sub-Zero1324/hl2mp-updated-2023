...
CON_COMMAND(chooseteam2, "Opens a menu for teamchoose")
{
	if (!gViewPortInterface)
		return;
	gViewPortInterface->ShowPanel("team2", true);
}
...
void CBaseViewport::CreateDefaultPanels( void )
{
	...
	//AddNewPanel(CreatePanelByName(PANEL_TEAM2), "PANEL_TEAM2");
#ifndef _XBOX
...
/*	else if ( Q_strcmp(PANEL_OVERVIEW, szPanelName) == 0 )
	...
	*/
	...
	//else if (Q_strcmp(PANEL_TEAM2, szPanelName) == 0)
	//{
