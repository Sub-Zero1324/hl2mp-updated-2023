...
// helper function
const char *GetStringTeamColor2( int i )
{
	switch( i )
	{
	case 0:
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CTeamMenu2::CTeamMenu2(IViewPort *pViewPort) : Frame(NULL, PANEL_TEAM2 )
{
	...
	LoadControlSettings("Resource/UI/TeamMenu2.res");
	InvalidateLayout();
...
//-----------------------------------------------------------------------------
void CTeamMenu2::LoadMapPage( const char *mapName )
{
...
//-----------------------------------------------------------------------------
void CTeamMenu2::MakeTeamButtons(void)
{
	int i = 0;
...
//-----------------------------------------------------------------------------
void CTeamMenu2::OnTeamButton( int team )
{
	char cmd[64];
...
//-----------------------------------------------------------------------------
void CTeamMenu2::SetLabelText(const char *textEntryName, const char *text)
{
