...
ConVar v_viewmodel_fov( "viewmodel_fov", "55", FCVAR_ARCHIVE, "Sets the field-of-view for the viewmodel.", true, 0.1, true, 179.9 );
#else
ConVar v_viewmodel_fov( "viewmodel_fov", "55", FCVAR_CHEAT, "Sets the field-of-view for the viewmodel.", true, 0.1, true, 179.9 );
#endif
...
void CViewRender::SetUpViews()
{
	...
	//view.fovViewmodel = g_pClientMode->GetViewModelFOV() - flFOVOffset; Sub-Zero - Removed for Stopping viewmodels from getting rotated when zooming
	view.fovViewmodel = fabs(g_pClientMode->GetViewModelFOV() - flFOVOffset); // Sub-Zero - Added for Stopping viewmodels from getting rotated when zooming
	if ( UseVR() )
	{
...
// Sub-Zero Added for Multiplayer Vehicle Fix.
...
// Sub-Zero Added for Multiplayer 
