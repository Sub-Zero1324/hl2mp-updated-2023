...
#ifdef HL2MP
	CSuitPowerDevice SuitDeviceSprint( bits_SUIT_DEVICE_SPRINT, 12.5f );				// 100 units in 4 seconds
#else
...
/* // Sub-Zero removed for old style movement
...
// Sub-Zero Added for old style movement
...
void CHL2_Player::CheatImpulseCommands( int iImpulse )
{
	...
	case 501: //Sub-Zero Changed to 501 to stop impulse 51 from being used.
	{
