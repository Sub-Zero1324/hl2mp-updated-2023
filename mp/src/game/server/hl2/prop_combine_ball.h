...
private:
	...
	// Pow!
	void DoExplosion( );
    void DoExplosion_internal(); // Sub-Zero Added to fix Invalid Combine Ball vphysics
    int OnTakeDamage(const CTakeDamageInfo &info); // Sub-Zero Added to fix Invalid Combine Ball vphysics
