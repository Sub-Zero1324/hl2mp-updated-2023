...
// Pow!
//------------------------------------------------------------------------------
//Sub-Zero Removed to fix Invalid Combine Ball vphysics
/*void CPropCombineBall::DoExplosion( )
{
	...
	// Tell the respawner to make a new one*/ //Sub-Zero Removed to fix Invalid Combine Ball vphysics

//Sub-Zero Added to fix Invalid Combine Ball vphysics
void CPropCombineBall::DoExplosion() {
