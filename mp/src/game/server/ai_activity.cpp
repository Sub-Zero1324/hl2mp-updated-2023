...
//===========================
	...
	ADD_ACTIVITY_TO_SR ( ACT_HL2MP_IDLE_GAUSS );
	ADD_ACTIVITY_TO_SR ( ACT_HL2MP_RUN_GAUSS );
	ADD_ACTIVITY_TO_SR ( ACT_HL2MP_IDLE_CROUCH_GAUSS );
	ADD_ACTIVITY_TO_SR ( ACT_HL2MP_WALK_CROUCH_GAUSS );
	ADD_ACTIVITY_TO_SR ( ACT_HL2MP_GESTURE_RANGE_ATTACK_GAUSS );
	ADD_ACTIVITY_TO_SR ( ACT_HL2MP_GESTURE_RELOAD_GAUSS );
	ADD_ACTIVITY_TO_SR ( ACT_HL2MP_JUMP_GAUSS );

	ADD_ACTIVITY_TO_SR ( ACT_HL2MP_IDLE_FLAMETHROWER );
	ADD_ACTIVITY_TO_SR ( ACT_HL2MP_RUN_FLAMETHROWER );
	ADD_ACTIVITY_TO_SR ( ACT_HL2MP_IDLE_CROUCH_FLAMETHROWER );
	ADD_ACTIVITY_TO_SR ( ACT_HL2MP_WALK_CROUCH_FLAMETHROWER );
	ADD_ACTIVITY_TO_SR ( ACT_HL2MP_GESTURE_RANGE_ATTACK_FLAMETHROWER );
	ADD_ACTIVITY_TO_SR ( ACT_HL2MP_GESTURE_RELOAD_FLAMETHROWER );
	ADD_ACTIVITY_TO_SR ( ACT_HL2MP_JUMP_FLAMETHROWER );
	...
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_DRIVE_AIRBOAT_LEFT);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_DRIVE_AIRBOAT);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_DRIVE_AIRBOAT_RIGHT);

	ADD_ACTIVITY_TO_SR(ACT_HL2MP_DRIVE_JEEP_LEFT);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_DRIVE_JEEP);
	ADD_ACTIVITY_TO_SR(ACT_HL2MP_DRIVE_JEEP_RIGHT);
