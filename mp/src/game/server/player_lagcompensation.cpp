...
static ConVar sv_lagcompensation_teleport_dist( "sv_lagcompensation_teleport_dist", "64", FCVAR_REPLICATED | FCVAR_CHEAT, "How far a player got moved by game code before we can't lag compensate their position back" );
...
ConVar sv_unlag_debug( "sv_unlag_debug", "0", FCVAR_GAMEDLL | FCVAR_REPLICATED );
